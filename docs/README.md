...
The client's documentation. Its subject is the **AddOn system**: the surface the client opens to code you
write yourself.
...
| [the examples](addons/examples.md) | the addons that ship with the client, and what each one shows |
