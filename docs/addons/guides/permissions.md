...
| [`w:position`, `w:size`, `w:visible`, `w:draggable`, `w:resizable`](../api/ui/native.md) | where the client's own windows sit and how big they are, and whether the user can drag or size one |
