...
| `.ttf` `.otf` | `"font"` | a [`FontHandle`](fonts.md) (its family is AWT-registered, so `$font[…]` works) | [`font =`](fonts.md#draw-with-it--your-own-widgets-f2), [`hafen.font.setFont`](fonts.md#restyle-a-global-surface--owned-overrides), [`node:setFont`](fonts.md#restyle-one-widget--nodesetfonth-f5) |
