...
sheet:rule("chat"):color{180, 190, 200}                     -- everything the four kinds below do not claim
...
sheet:rule("chat.log"):bg{ color = {9, 13, 22, 200} }                   -- ...and the wash behind one channel
