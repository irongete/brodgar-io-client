...
[connection](../websocket.md) or a [voice link](../voice/README.md) to a server, and [waiting for a widget](../ui/replace.md#watching-for-a-widget). A `Sub` answers those two verbs and
