...
Both are the Steam client's own moments, not a character's: they fire once per client, whichever session is
on screen, and not at all on a client started outside Steam.
