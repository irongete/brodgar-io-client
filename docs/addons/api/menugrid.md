...
Your entries are **bridge-owned**. Reloading or disabling your addon takes every one of them back out — from
every character — so each menu is the game's own catalogue again, with nothing left.
