...
> a marker you want to keep or share goes through [`marker:anchor()`](map/markers.md#the-marker-object) first;
> see [saving a position](map/grids.md#saving-a-position).
