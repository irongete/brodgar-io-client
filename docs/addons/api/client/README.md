...
[connection](../websocket.md) or a [voice link](../voice/README.md) said, a [line of chat](../event/bus/chat.md). The client makes one a frame, and each character one of its own, so a
