...
| **Networking & IO** | [`http`](api/http.md), [`websocket`](api/websocket.md), [`json`](api/json.md), [`asset`](api/asset/README.md), [`sound`](api/sound.md), [`voice`](api/voice/README.md), [`steam`](api/steam.md) | External HTTP/WebSocket communication, JSON parsing, sound effects, voice audio, addon assets, and Steam integration. |
