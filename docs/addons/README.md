...
| **Character** | [`player`](api/player.md) · [`time`](api/time.md) · [`char`](api/char.md) · [`study`](api/char.md#hafenstudy) · [`party`](api/party.md) · [`items`](api/items.md) · [`buff`](api/buffs.md) · [`meter`](api/meters.md) |
