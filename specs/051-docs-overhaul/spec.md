...
- [ ] `specs/standards/docs.md` and `information-architecture.md` exist and state the
...
- `specs/standards/docs.md` + `information-architecture.md` — written by task 051.1,
  read by every later task.
- `specs/PROJECT.md` — the boundary: who writes reference content after this lands.
- `specs/STATE.md` — what actually shipped, feature by feature; the ground truth prose is
