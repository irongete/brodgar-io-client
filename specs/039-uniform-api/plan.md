...
4. **Ships its self-checking suite** `addons/039-uniform-api.<N>/` per `specs/testing/addon-suite.md`.
...
- `specs/` — `design/25-uniform-api.md` (the standing design), `DECISIONS.md` +
...
Per `specs/testing/addon-suite.md`, unchanged: one self-checking addon per task, `:t039-<N>`, printing
