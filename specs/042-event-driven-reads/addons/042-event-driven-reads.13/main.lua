...
-- once. Self-checking suite; see specs/testing/addon-suite.md and specs/042-event-driven-reads/{spec,plan,tasks}.md.
--
...
-- proven in its own task's suite (archived under specs/042-event-driven-reads/addons/) -- this suite's
