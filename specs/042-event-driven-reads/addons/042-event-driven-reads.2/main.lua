-- 042.2 -- buffs, and the fade that is not a removal. Self-checking suite; see specs/testing/addon-suite.md
-- and specs/042-event-driven-reads/{spec,plan,tasks}.md.
--
