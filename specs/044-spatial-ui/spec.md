...
- `specs/043-vr-namespace/` — the namespace this lands in; **read its spec first**
...
- `specs/design/07-ui-and-drawing.md` — LuaWidget/LuaWindow, the Draw event, GOut wrapper
- `specs/031-window-lifecycle/` — D-070, the restore rule native standing inherits
- `specs/026-text-cache/`, `019-profiling/` — the dirty-cache and counter precedents
