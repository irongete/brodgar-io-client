...
load → draw / decorate / stand — with no path-string shortcut at the use sites ([D-012](../decisions/superseded/architecture-api.md):
...
- [ ] **One flow, no sugar** ([D-012](../decisions/superseded/architecture-api.md)): consumers take a **handle only** —
