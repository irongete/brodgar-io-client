...
§3 and §6, still uses `hafen.act():moveTo(p)` as its own worked example of D-007, still names
...
- [ ] The "Filed to area `addons` and still open" list in `specs/docs/STATE.md` is re-checked against
...
- `specs/docs/design/style-guide.md` — the standard being applied and, in §3/§6/§7, edited
- `specs/docs/design/information-architecture.md` — §3 is the tree and the authority; it is stale
- `specs/docs/decisions/docs-standard.md` — D-001..D-016; the new decision appends here
- `specs/addons/048-act-dissolved/` — the map of what moved where, and the eight tasks' own reports
- `specs/addons/047-flowermenu/` — the correlation rule and the two events
...
- `specs/docs/005-api-rewrite-review/census.md` — the census shape this feature repeats
