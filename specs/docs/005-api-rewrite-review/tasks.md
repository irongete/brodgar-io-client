...
- [x] **005.1 — The census, and the worklist everything else works from.** Build the surface → page map
      ...
      with its owning task, **005.2 or 005.3**. Fix nothing here.
...
- [x] **005.4 — The standard, the sweep, and the close.** **(a) §7 becomes derived** from
      ...
      the engine refuses corrected. That is **D-015**; falsify every entry both ways — an admitted
      ...
      the rule rather than clarifying it, **D-016**. An obituary turned description leaves the
      ...
      **Reports**: D-015 (and D-016 if taken) with its reasoning · the derivation re-run, both
