...
- `decisions/docs-standard.md` — D-001..D-018 — the page standard and the shape of the tree: the
  ...
  standard reads in the shipped `protected` / `unprotected` adjective, and that a directory under
  `api/` means a namespace while a type page splits into a sibling
