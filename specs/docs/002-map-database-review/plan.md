...
- `specs/docs/design/style-guide.md` — §7 grep list gains the eight names `037` retired
- `specs/docs/design/information-architecture.md` — §3's target tree gains `api/map/`; §7 records the tier widening as done
- `specs/docs/AREA.md`, `specs/addons/AREA.md` — the addons docs tier reads `docs/addons/**`
- `specs/docs/STATE.md` `FEATURES.md` `LEARNINGS.md` (+ `learnings/docs-maintenance.md`) — closed by `/end`
