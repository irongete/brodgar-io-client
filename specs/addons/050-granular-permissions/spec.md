...
- `decisions/actions-permissions.md` — D-027/D-028 the model, D-213 gate-before-argument-check (which is what lets a suite prove a grant without acting), D-219 protected-wherever-it-lives, D-220 no-self-probe
...
- `specs/docs/design/style-guide.md` §9–§12 — the docs standard, read before writing any page
