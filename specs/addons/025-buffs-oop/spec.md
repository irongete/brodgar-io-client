...
- `specs/addons/design/14-widget-tree-reads.md` — the adapter mechanism this sits on
- `specs/addons/design/06-lua-api.md` — the read API surface + its OOP banner
...
- `specs/addons/024-audio-oop/`, `021-actionbar-oop/` — prior art for the migration + event payload
