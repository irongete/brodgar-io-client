...
> The decisions (D-001..D-067) live in `decisions/`, split by category — the same shape
...
- [widgets-ui](decisions/widgets-ui.md) — wrap-not-reimplement, hook priority, replacement descriptor, drops/g:resource/mods, WidgetNode + hit-testing, a classifier answers only where the widget IS the thing (D-067) (D-009, D-021, D-024, D-038, D-039, D-040, D-041, D-042, D-067)
