...
- `specs/addons/design/14-widget-tree-reads.md` — the adapter mechanism this rewires (the `VitalsAdapter` row)
- `specs/addons/025-buffs-oop/` — the template: widget-identity interning, `fireBuff`, the flat hard cut
