...
> Hard-won, non-obvious facts (418 entries), split by category under `learnings/`. **Never read
...
- [ui-widgets.md](learnings/ui-widgets.md) — custom windows/widgets, `LuaGOut`, HUD/gob overlays, drops, widget internals (`add` vs `addchild`), the W-series introspection/hit-testing and the Widget entity (interning, provenance, container items).
