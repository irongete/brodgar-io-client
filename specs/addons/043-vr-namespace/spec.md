...
- `specs/addons/design/24-gob-overlays.md` — D-100/102/103, and the absorption this partly reverses
- `specs/addons/design/17-custom-rendering.md`, `16-virtual-entities.md` — the shared world-entity
  core all four kinds already sit on
- `specs/addons/038-gob-overlays/`, `039-uniform-api/` — the feature being partly reversed, and
  the precedent for a reorganization shipped as its own feature
- `specs/addons/learnings/rendering.md` (R2/R2b, 038.2) and `learnings/ghosts.md` — the entity
