...
- `specs/addons/design/07-ui-and-drawing.md` — specified `hafen.ui.gobOverlay`; this supersedes §"World-space overlays over gobs"
- `specs/addons/design/17-custom-rendering.md` — specified `follow=`/`:follow`; this supersedes it
...
- `specs/addons/017-gob-oop/` — the Gob entity, its interning and the hard-cut precedent
- `specs/addons/011-virtual-entities/` — `hafen.ghost`, the handle whose `follow` is absorbed
