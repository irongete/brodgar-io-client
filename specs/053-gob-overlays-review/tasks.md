...
- [x] **053.1 — the accuracy pass: what the pages say, checked against what shipped.** Run the
...
- [x] **053.2 — the standard, and the close.** The four obituaries become present-tense boundaries
      ...
      **`[manual]`**: that no page reads as a change note any more — the §7 test applied by hand, deleting
      ...
      <!-- extra context: `specs/standards/docs.md` §7 (only this task edits it) -->
