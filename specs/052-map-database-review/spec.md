...
- [ ] `specs/PROJECT.md` and `specs/PROJECT.md` state the addons docs tier as `docs/addons/**` —
...
- `specs/standards/docs.md` — the standard being enforced (§6 facts, §7 no history, §9 size, §12 checks)
- `specs/standards/docs-ia.md` — rules 2–4 (namespace → path → directory + hub), §7 ownership, §8 link discipline
- `specs/decisions/docs-standard.md` — D-231..D-241, opened per entry, never whole
...
- `specs/037-map-database/spec.md` + `tasks.md` — what shipped, and in which order
