...
- [x] **052.1 — the split**: `docs/addons/api/map.md` becomes `docs/addons/api/map/` — the hub plus
...
- [x] **052.2 — the close**: the standard and the contract catch up with what shipped. `style-guide.md`
      ...
      done; `specs/PROJECT.md` and `specs/PROJECT.md` read `docs/addons/**`. Wrap drift goes to zero
      ...
      **`[manual]`**: that the two `AREA.md` wordings still describe their areas correctly after the
      ...
      <!-- extra context: `specs/PROJECT.md`, `specs/PROJECT.md` (only this task edits them) -->
