...
- [ ] **The refused spellings are settled against D-243.** `inventory[title=…]`, `*[title=…]`, bare
...
- `specs/standards/docs.md` — the standard; §6, §7, §9 and §12 are what this feature runs
- `specs/standards/docs-ia.md` — §3's tree and figures, which this feature
  re-derives
- `specs/decisions/docs-standard.md` — D-236, D-238, D-243, D-245 (the one-liners via
  `grep "^### D-"`; open only the entry named)
- `specs/049-css-selectors/` — spec, plan and tasks: what shipped, and each task's close
...
- `specs/056-act-dissolved-review/` — the previous review: its census shape and §12 report are
