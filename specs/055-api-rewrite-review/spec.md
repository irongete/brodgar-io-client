...
- [ ] **§7 is current and falsified.** The names `039`, `041` and `043` retired are admitted
      under D-243's rule (or refused in writing, with the reason, as `:offset(` was); the "live"
...
- `specs/standards/docs.md` — the standard being enforced, and §7/§12 are edited here
- `specs/standards/docs-ia.md` — the target tree, which the review updates
- `specs/decisions/docs-standard.md` — D-231..D-244, one entry opened at a time
- `specs/learnings/docs-maintenance.md` — the slugger trap and the checker that over-reported
- `specs/053-gob-overlays-review/`, `004-ui-controls-review/` — the review method that found
...
- `specs/039-uniform-api/`, `041-unified-events/`, `043-vr-namespace/`,
  `044-spatial-ui/`, `045-durable-places/`, `046-gob-scale/` — what shipped, per task
- `specs/042-event-driven-reads/` — no `hafen.*` change, but it changed **when** events
