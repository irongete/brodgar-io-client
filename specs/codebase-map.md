...
| [services.md](codebase/services.md) | Console, keybindings, `Resource` (+ code adoption), prefs + Options/`GSettings`, audio, chat, combat, buffs, kin, vitals, FEP/hunger, study, skills/credos/lore, crafting, action menu (`MenuGrid` paginae), minimap icon registry (`GobIcon.Settings`) |
