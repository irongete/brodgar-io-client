...
- `docs/addons/api/resource/README.md`, `docs/addons/api/resource/layers.md` — 2, 3, 4 · `docs/client/resource-loading.md` — 2, 4
- `src/io/brodgar/addon/ResourceApi.java` (`name`), `LuaResource.java` (`res`, `layers`), `LuaLayer.java`, `LayerCodec.java` (`type`/`key`/`at`, `snapshot`, `value`) — 2, 3, 4
