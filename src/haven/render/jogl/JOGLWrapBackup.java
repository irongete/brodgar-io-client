...
public class JOGLWrapBackup implements GL, WrappedJOGL {
    ...
    public void glGetProgramBinary(int program, int bufsize, int[] length, int[] format, ByteBuffer binary) {back.getGL2ES2().glGetProgramBinary(program, bufsize, length, 0, format, 0, binary);}   // addon: ProgramCache
    public void glProgramBinary(int program, int format, ByteBuffer binary, int length) {back.getGL2ES2().glProgramBinary(program, format, binary, length);}   // addon: ProgramCache
    public void glProgramParameteri(int program, int pname, int value) {back.getGL2ES2().glProgramParameteri(program, pname, value);}   // addon: ProgramCache
