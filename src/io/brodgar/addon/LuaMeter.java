...
public final class LuaMeter {
    ...
    static final class Cache {
        ...
        /**
         * <b>The widget died, so its entry goes</b> (128.5) — the meter widget is gone. The key is
         ...
         */
        synchronized void retire(IMeter m) {
            if(m != null)
                live.remove(m);
        }
    ...
    private static LuaValue buildMeta(final Addon owner) {
        ...
        mt.set(LuaValue.INDEX, Refusal.closedIndex("meter", methods(owner),
            "a meter is one bar in the HUD meter slot"));
