...
/**
 * A <b>global hotkey</b> binding (spec {@code 07-ui-and-drawing.md} "Input" / {@code api-reference} {@code
 * hafen.key}) — the Java half of {@code hafen.key.bind(name, defaultKey, fn)}, Phase 2e-2. It pairs a client
 ...
 *
 * <p>The addon never sees this object: it gets an opaque handle ({@code :remove()} / {@code :key()}), and the
 * bridge owns the bind for teardown ({@link Addon#keybinds}, principle P2). The {@link #alive} flag makes a
