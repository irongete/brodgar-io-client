 ...
 * Bounded by {@link #MAX_RETRIES}: past that the value is left unresolved and <b>stays</b> unresolved until
 * something else announces it — never a fallback poll.
 *
            ...
            l.waitfor(() -> {
                ...
                AddonManager.enqueueResolve(() -> {
                    ...
                    try {
                        ...
                        register(l2, owner, retry, depth + 1);
